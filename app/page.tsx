...
const translations: Record<Lang, Translation> = {
  en: {
    ...
    heroHeadline: "Track your order clearly from purchase to delivery.",
    heroDescription:
      "Follow every step of your order from Shein purchase, Dubai handling and final delivery in Kurdistan.",
    routeShein: "Shein",
    routeDubai: "Dubai",
    ...
    idleText: "Write the number only, or paste the full code like DS215.",
    privacyNote: "Some customer details are hidden for privacy.",
    notFound: "Order not found. Please check the number and try again.",
    connectionError: "Connection error. Please try again.",
    orderCode: "Order Code",
    currentStage: "Current Stage",
    completed: "Completed",
    progress: "Progress",
    expected: "Estimated time for this stage",
    journey: "Journey Map",
    ...
    whatsapp: "WhatsApp",
    instagram: "Instagram",
    waMessage: "Hello, I have a question about my order. Order code: ",
  ...
  ku: {
    ...
    heroKicker: "ئیمارات → کوردستان · ڕێڕەوی تایبەتی کڕین",
    heroHeadline: "داواکارییەکەت بە ڕوونی بەدواداچوون بکە.",
    heroDescription:
      "لە کڕین لە شێئینەوە، تا ئامادەکردن لە دوبەی و گەیاندنی کۆتایی لە کوردستان، هەموو قۆناغەکان بە شێوەیەکی ڕوون پیشان دەدرێن.",
    routeShein: "شێئین",
    routeDubai: "دوبەی",
    ...
    terminalTitle: "سەنتەری بەدواداچوون",
    liveLookup: "گەڕانی ڕاستەوخۆ",
    placeholder: "ژمارەی داواکاری بنووسە",
    trackBtn: "بەدواداچوون",
    searching: "دەپشکنرێت...",
    idleTitle: "کۆدی داواکارییەکەت بنووسە",
    idleText: "تەنها ژمارەکە بنووسە، یان کۆدی تەواو وەک DS215 دابنێ.",
    privacyNote: "هەندێک زانیاری کڕیار بۆ پاراستنی تایبەتمەندی شاراوە دەکرێت.",
    notFound: "داواکاری نەدۆزرایەوە. تکایە ژمارەکە بپشکنە و دووبارە هەوڵ بدە.",
    connectionError: "کێشەی پەیوەندی ڕوویدا. تکایە دووبارە هەوڵ بدە.",
    orderCode: "کۆدی داواکاری",
    currentStage: "قۆناغی ئێستا",
    completed: "تەواو بوو",
    progress: "پێشکەوتن",
    expected: "ماوەی پێشبینیکراو بۆ ئەم قۆناغە",
    journey: "نەخشەی گەشت",
    ...
    titleMr: "بەڕێز",
    titleMiss: "خاتوو",
    needHelp: "پێویستت بە یارمەتییە لەسەر ئەم داواکارییە؟",
    whatsapp: "واتساپ",
    instagram: "ئینستاگرام",
    waMessage: "سڵاو، پرسیارم هەیە دەربارەی داواکارییەکەم. کۆدی داواکاری: ",
    adminPasswordPrompt: "تکایە وشەی نهێنی ئەدمین بنووسە:",
    adminWrongPassword: "وشەی نهێنی هەڵەیە!",
    s0: "داواکاری تۆمارکرا",
    s2: "ئامادەکردن لەلایەن شێئین",
    s3: "نێردراوە بۆ دوبەی",
    s4: "گەیشتووە بە دوبەی",
    s6: "لە ڕێگایە بۆ کوردستان",
    s7: "وەرگیراوە و پاکەت دەکرێت",
    s8: "لە ڕێگای گەیاندندایە",
    s9: "گەیەنراوە",
  ...
  ar: {
    ...
    heroKicker: "الإمارات → كردستان · مسار تسوّق خاص",
    heroHeadline: "تتبّع طلبك بوضوح من الشراء حتى التسليم.",
    heroDescription:
      "تابع كل مرحلة من طلبك، من الشراء من شي إن، إلى التجهيز في دبي، ثم التسليم النهائي في كردستان.",
    routeShein: "شي إن",
    routeDubai: "دبي",
    ...
    terminalTitle: "مركز التتبع",
    liveLookup: "بحث مباشر",
    placeholder: "أدخل رقم الطلب",
    trackBtn: "تتبّع الطلب",
    searching: "جاري التحقق...",
    idleTitle: "أدخل كود طلبك",
    idleText: "اكتب الرقم فقط، أو الصق الكود الكامل مثل DS215.",
    ...
    completed: "مكتمل",
    progress: "التقدم",
    expected: "المدة المتوقعة لهذه المرحلة",
    ...
    currencyIQD: "دينار",
    printBtn: "تحميل إيصال PDF",
    titleMr: "السيد",
    titleMiss: "الآنسة",
    needHelp: "هل تحتاج مساعدة بخصوص هذا الطلب؟",
    whatsapp: "واتساب",
    instagram: "إنستغرام",
    waMessage: "مرحباً، لدي استفسار بخصوص طلبي. كود الطلب: ",
    adminPasswordPrompt: "يرجى إدخال كلمة مرور الإدارة:",
    adminWrongPassword: "كلمة المرور غير صحيحة!",
    s0: "تم تسجيل الطلب",
    s2: "قيد التجهيز من شي إن",
    s3: "تم الشحن إلى دبي",
    s4: "وصل إلى دبي",
...
export default function OrderTracking() {
  ...
  useEffect(() => {
    setIsAdmin(localStorage.getItem("dalinIsAdmin") === "true");
  }, []);
